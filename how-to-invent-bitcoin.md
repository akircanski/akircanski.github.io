...
If there's something _general_ in the picture of a computer connected to a telephone which has the potential to trigger such a reaction, then the same matter is present in the idea that a short blob of bytes in one's personal computer can have monetary value. This is in fact a dream come true - bytes that extend into the real world, even though they exist exclusively inside a personal device. You could imagine a young soul feeling empowered with just that (or, drawn into hacking or computer science).
...
**Note**: this blog post doesn't endorse or suggest buying Bitcoin. On the contrary, I vaguely believe most of the original intent behind Bitcoin was lost over time and am fairly tired of various banks proclaiming that Bitcoin is digital gold. I do believe that other solutions in the space now carry the torch of the original idea. 
