...
But there's another surprising thing that's not talked about in school, at least not in high school and apparently not in undergraduate school either. It has to do with the **scope** and **expresiveness** of general purpose computing. A single-purpose computer, eg. a calculator, can only do certain type of tasks whereas a [general-purpose computer](https://www.computerhope.com/jargon/g/general-purpose-computer.htm) can run any conceivable algorithm including simulating single-purpose computers. Because of this expresivness, general purpose computation can capture aspects of our society in unexpected ways and modify our life for good, or for bad. 
