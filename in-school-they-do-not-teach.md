...
But there's another surprising thing that's not talked about in school, at least not in high school and apparently not in undergraduate school either. It has to do with the **scope** and **expresiveness** of general purpose computing. A single-purpose computer, e.g. a calculator, can only do certain type of tasks whereas a [general-purpose computer](https://www.computerhope.com/jargon/g/general-purpose-computer.htm) can run any conceivable algorithm including simulating single-purpose computers.

Because of this expresivness, general purpose computation can capture aspects of our society in unexpected ways and modify our life for good, or for bad. 
...
Certain computation performed jointly by humans in the past is therefore simulated and executed by a computer. 
...
In school, they never taught that efficient general purpose computing is an botomless well, or perhaps a limitless ocean. Still, school taught us the distant principles on which all of that was build, so that's good. This reaffirms what may not be obvious to teenagers - school is good. 


Acknowledgments: This blog post is inspired by the book by [Martin Davis](https://en.wikipedia.org/wiki/Martin_Davis_(mathematician)) ["The Universal Computer"](https://www.youtube.com/watch?v=ZVTgtODX0Nc) and also by the works of [Nick Szabo](https://nakamotoinstitute.org/authors/nick-szabo). I'd like to thank Jovan Todorović for reading this text thoroughly and pointing out that I omitted to explicitly mention where the key event in inventing Bitcoin actually was. The key realization was somewhere between steps 6 and 7, where Satoshi realized that proof of work can be used to compete between anonymous participants to compete with each other. In addition to that, Satoshi had a belief that the mining competition would swing into action, increasing the bar of entry - it's unclear that an ordinary person would bet that this would happen. I'd also like to thank [_Miloš Milovanović_](https://www.mi.sanu.ac.rs/novi_sajt/members/fulltime/milosm.php) and _Vojin Jovanović_ for various discussions. I'd also like to thank this blog post reviewer _Ron Lebow_ who ran the [Write Together](https://www.meetup.com/nyc-book-writing-meetup-group/events/299763741/?recId=2fb48ffc-54b0-4615-bf2a-7a0f37f6955f&recSource=member-event) meetup at Morty's bar in Hell's Kitchen in New York. 
