...
So, this is a gorge located in the middle of the Balkans; in southern Serbia,  where the Dinaric mountains start off in the east. It's where the first eastern wrinkles of Dinaric mountain massive start swinging in full force.
...
<table>
  <tr>
    <td><img src="other-pics/milesevka/signpost.jpg" alt="First Image" width="50%"></td>
...
It is also possible that I'm just wrong and that there was an extension of the trail, but I could not find it. I'll leave it for the future to tell (I'll try to contact the folks responsible for trails to find out and will update the post if anything noteworthy comes up). 
...
I walked away from the monastery to the nearby entrance to the gorge. I encountered a local embarking lumber on a small truck and asked him about the gorge. He uttered something that read like a warning: that the track is unmaintained and that there are snakes. At this point, I can't tell whether the number of snakes is higher than one would expect; the local population, who does almost never goes throughout the whole gorge and probably does not step in at all, may be biased in this regard. Still, having encountered [Vipera ammodytes](https://en.wikipedia.org/wiki/Vipera_ammodytes) recently on other hiking trips, I decided to undertake systematic measures to scare off the snakes in front of me, using a wooden stick with leaves at the tip.

### The abandoned project of building a road from Prijepolje to Sjenica 

The hiking track unravels ahead as an abandoned road construction project: the road to Prijepolje to Sjenica. Prijepolje and Senica are colorful cities in deep south of Serbia; they both have a strong Muslim community, as that's a place where the Ottoman empire left strong traces through the history of this region. These towns can be seen as gateways between the two empires (the Ottoman on the one hand, and the European on the other) which results in bustling diversity. If a Westerner travels towards the east, those types of towns are the first places where they'll spot a mosque and a public prayer in regular interals throughout the day. 

Back to the construction of the road: it involved carving tunnels through the rock; the demonic cliffs needed to be punctured which, I imagine, took tremendous force and workers' sweat. It started in 1949, but the project was halted in 1951. It was then restarted (by Yugoslavian authorities) some 20 years later (late 70ties), but was abandoned once again. It is chronicled in some detail [here](https://www.sjenica.com/2015/05/prijepoljci-zele-put-prema-sjenici-kroz-milesevku/?utm_source=chatgpt.com). 
...
Heigh-wise, the track is dangerous by itself and probably should not be hiked if you have fear of height. However, cliff-wise, there are three specifically dangerous locations.
...
All in all, I'm of opinion that the track isn't anywhere near maintained for _general_ hiking; it is an adventure. With it, you're on your own, be careful especially if you're carrying a heavy backpack with a tent or sleeping bag extension, as it can interfere with straight walking. 

### The seemingly incorrect signpost

Despite the dangers, most of the trail is well marked. Towards the end of the hike when coming from the monastery direction, the trail descends into the cliff and crosses Mileševka. It leads to a place with a wooden bench and a signpost. It is quite surreal to see a wooden bench there. The bench is likely maintained by folks that approaching it from the other direction, which does not require going through the gorge. 

After some debate I followed the Međani sign (see the pictures at the beginning of this blog post). I reached the location which, supposedly, is a dead-end - according to the hiking app trail map (see the hiking app picture on the right at the begining of the post). At this stage, I was very tired and was low on water. This is because I took 2.5 liters to the gorge with me, but the hike under the sun took its tool; I also had some minor injuries I needed to clean with water. I was also out of signal for mobile network and needless to say, quite concerned.

Anyway, I reached the trail dead-end. I had two choices; go back or press forward by walking up the riverbed of the Međani brook. I opted for the latter - I managed to soldier through the foliage and waterfalls by hopping from rock to rock and walking through the thick foliage, where possible. At some point, I decided to wet my shoes to be able to move through what appeared to be impenetrable thickery of plants, waterfalls and rock. I do not recommend going this path; the risk of injury is high. Take the 3rd route - unfortunately I cannot remember the exact name of the third signpost goal, but it is a "Česma" (source of water).
